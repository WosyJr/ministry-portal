...
const RAW = [
  ...
  },
  {
    ...
    sections: [
      ...
      { h: 'The Answer of the Party Sought', note: 'Completed by the party to whom this request is sent.', kv: [O('Answer', ['Accepted as proposed', 'Accepted, another time proposed below', 'Declined']), D('Date Agreed'), T('Hour Agreed'), T('Place Agreed'), T('Signature of the Party Sought')] },
      { h: 'Remarks of the Party Sought', lines: 3 }
    ],
