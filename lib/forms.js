...
const RAW = [
  ...
  },
  {
    ...
    sections: [
      ...
      { h: 'Acceptance', party: 'the appointee', kv: [F('Oath of Acceptance', 'I accept the office and shall act within Imperial law and the lawful bounds of the portfolio.'), T('Appointee Signature', { required: true }), D('Date Accepted', { required: true })] }
    ],
  ...
  },
  {
    ...
    sig: ['Petitioner', 'Receiving Officer'], sigParty: 0
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      { h: 'Inquiry', kv: [T('Subject / Matter', { required: true }), T('Origin'), T('Assigned Adjudicator'), T('Authorizing Officer'), D('Date Opened'), T('Delegation / Jurisdiction Basis', { list: 'laws' })] },
  ...
  },
  {
    ...
    sections: [
      ...
      { h: 'Notice', kv: [T('To', { required: true }), T('Inquiry No.'), T('Issued By'), D('Date Issued'), T('Authority / Delegation', { list: 'laws' })] },
  ...
  },
  {
    ...
    sections: [
      ...
      { h: 'Origin', kv: [T('Inquiry'), T('Subject', { required: true }), T('Adjudicator'), D('Date of Finding'), T('Authority / Delegation', { list: 'laws' })] },
  ...
  },
  {
    ...
    sig: ['Referring Officer', 'Receiving Authority / Acknowledgment'], sigParty: 1
  },
  {
  ...
  },
  {
    ...
    sig: ['First Party', 'Second Party', 'Ministry Witness'], sigParty: [0, 1]
  },
  {
  ...
  },
  {
    ...
    sig: ['Author', 'Recipient / Acknowledgment'], sigParty: 1
  },
  {
    ...
    sections: [
      ...
      { h: 'Return', kv: [O('Method', ['Inspection', 'Copy', 'Account', 'Written Cooperation']), D('Requested Return'), D('Received', { party: 'theirs' }), T('Objection / Limitation Raised', { party: 'theirs' })] }
    ],
    sig: ['Issuing Minister / Authorized Officer', 'Receiving Custodian'], sigParty: 1
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      { h: 'License', kv: [O('Kind', ['Press License', 'Printing License', 'Literature License', 'Other']), T('Governing Law / Delegation', { required: true, list: 'laws' }), D('Date Issued'), D('Expires'), O('Standing', ['In Force', 'Suspended', 'Revoked', 'Lapsed'])] },
      { h: 'Conditions of License', lines: 4 }
    ],
    sig: ['Issuing Officer', 'Imperial Registrar / Minister']
  },
  {
    key: 'meeting', file: '25', folder: 'correspondence', num: 'Audience', subject: 'party-sought', summary: 'the-matter-to-be-discussed',
    title: 'Request for an Audience or Meeting', subtitle: 'Request by the Ministry for a meeting with another office, House or party', tag: 'Request for Audience',
    preamble: 'The Ministry of Civil and Administrative Affairs presents its compliments and requests an audience of the party named below, upon the matter here set down. This writ is sent that the time and place may be agreed in good order and entered upon the Ministry rolls.',
    sections: [
      auth('Lex Ordo Debitus, the duty of audience and of orderly dealing between the offices of the province.', 'A request for audience compels no one. It does not summon a party before the Ministry, nor oblige any office to disclose what law protects.'),
      { h: 'The Party Sought', kv: [T('Party Sought', { required: true }), T('Style or Title'), T('Ministry, Hold or House'), T('Where the Party May Be Found')] },
      { h: 'The Ministry', kv: [F('Requesting Ministry', MINISTER), T('Requesting Officer', { required: true }), T('Secretary or Delegate Arranging'), O('Manner Proposed', ['In person', 'By delegate', 'By written exchange'])] },
      { h: 'The Meeting Proposed', kv: [D('Proposed Date'), T('Proposed Hour'), T('Proposed Place'), T('Expected Duration'), O('Standing', ['Routine', 'Pressing'])] },
      { h: 'The Matter to be Discussed', note: 'Set down plainly what the Ministry wishes to treat of, that the party may come prepared.', lines: 4 },
      { h: 'The Answer of the Party Sought', party: 'the party sought', note: 'Completed by the party to whom this request is sent.', kv: [O('Answer', ['Accepted as proposed', 'Accepted, another time proposed below', 'Declined'], { required: true }), D('Date Agreed'), T('Hour Agreed'), T('Place Agreed'), T('Signature of the Party Sought', { required: true })] },
      { h: 'Remarks of the Party Sought', party: 'the party sought', lines: 3 }
    ],
    sig: ['Requesting Officer', 'The Party Sought'], sigParty: 1
  }
];
