...
const RAW = [
  ...
  },
  {
    ...
    sections: [
      ...
      { h: 'Petitioner', kv: [T('Name', { required: true }), T('Residence / Hold'), T('Standing / Occupation'), T('Representative'), O('Means of Reply', ['Courier', 'In Person', 'Through Envoy', 'Other'])] },
      { h: 'Matter', kv: [O('Nature', ['Public Information', 'Publication', 'Ministry Conduct', 'Request', 'Other']), T('Persons / Offices Concerned'), T('Hold(s)')] },
      { h: 'Statement', lines: 6 },
  ...
  },
  {
    ...
    sections: [
      ...
      { h: 'Record of Service', kv: [T('Delivered To'), O('Means', ['By Hand', 'Courier', 'Through Envoy', 'Other']), D('Date Delivered')] }
    ],
    sig: ['Imperial Adjudicator', 'Authorizing Officer']
  },
  {
  ...
  },
  {
    ...
    preamble: 'From the Imperial Envoy of the Ministry, in the field among the Holds of Skyrim, to the Imperial Emissary: this Dispatch, faithfully rendered, of all that was seen, heard, and done in the period below.',
    sections: [
      auth('Civil and Administrative Affairs portfolio under Codex Officiorum Provinciae; ministerial staffing under Article IV.', "An Imperial Envoy of this Ministry is a civil-information liaison unless separately commissioned. The office does not independently exercise the Governor's diplomatic portfolio, command Hold authorities, investigate crimes, or bind a Jarl or peer institution."),
      { h: 'Envoy', kv: [T('Envoy'), T('Assigned Holds / Route', { required: true }), T('Reporting Period'), O('Sent To', ['Imperial Emissary', 'Ministry Superior'])] },
    ...
    sig: ['Imperial Envoy', 'Receiving Superior']
  },
  {
...
module.exports = { FORMS, BY_KEY, MINISTER, slug };
