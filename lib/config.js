...
module.exports = {
  ...
  DEV_LOGIN: env('DEV_LOGIN', '') === '1' && env('NODE_ENV', '') !== 'production',
  DATA_DIR: env('DATA_DIR', path.join(__dirname, '..', 'data')),
  DISCORD_CLIENT_ID: env('DISCORD_CLIENT_ID', ''),
  DISCORD_CLIENT_SECRET: env('DISCORD_CLIENT_SECRET', ''),
  DISCORD_GUILD_ID: env('DISCORD_GUILD_ID', ''),
  DISCORD_STAFF_ROLE_IDS: list('DISCORD_STAFF_ROLE_IDS'),
  DISCORD_ADMIN_ROLE_IDS: list('DISCORD_ADMIN_ROLE_IDS'),
  STAFF_DISCORD_IDS: list('STAFF_DISCORD_IDS'),
