...
const DEPTS = [
  ...
  { id: 'register', tab: 'Administrative Office', title: 'Administrative Office', lede: 'Keeper of the rolls, the seals, the letters and the printed word. Kept by the Imperial Registrar.', folders: ['register', 'seals', 'correspondence', 'ledgers', 'archives'], forms: ['register-entry', 'seal', 'authentication', 'correspondence', 'meeting', 'archive'],
  ...
  { id: 'directives', tab: 'Directives', title: 'Directives & Ministerial Orders', lede: 'The standing orders, memoranda and council minutes issued under the Minister’s hand.', folders: ['directives'], forms: ['directive', 'memorandum', 'proceedings', 'requisition'] }
];
